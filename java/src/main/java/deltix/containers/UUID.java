...
import deltix.containers.interfaces.BinaryConvertibleReadWrite;
import deltix.containers.interfaces.BinaryArrayReadOnly;
import deltix.containers.interfaces.UUIDParseFormat;
import deltix.containers.interfaces.UUIDPrintFormat;
import deltix.containers.interfaces.UUIDReadOnly;

import java.util.Random;

public class UUID implements Comparable<UUID>, deltix.containers.interfaces.UUID {
    ...
    public void copyTo(deltix.containers.interfaces.UUID destination) {
        if (destination == null)
    ...
    @Override
    public void toMutableString(deltix.containers.interfaces.MutableString string) {
        string.assign(this, UUIDPrintFormat.UPPERCASE);
    }

    @Override
    public void toMutableString(deltix.containers.interfaces.MutableString string, UUIDPrintFormat format) {
