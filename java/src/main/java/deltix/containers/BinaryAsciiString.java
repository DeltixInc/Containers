...
import deltix.containers.interfaces.UUID;
import deltix.containers.interfaces.MutableString;
...
public class BinaryAsciiString implements CharSequence, deltix.containers.interfaces.BinaryAsciiString {
    ...
    public UUIDReadOnly toUUID() {
        return new deltix.containers.UUID(this);
    }
    ...
    public UUIDReadOnly toUUID(UUIDParseFormat format) {
        return new deltix.containers.UUID(this, format);
    }
    ...
    @Override
    public deltix.containers.interfaces.MutableString clone() {
        return new deltix.containers.MutableString().assign(this);
    }
    ...
    public String toString() {
        MutableString builder = new deltix.containers.MutableString();
