package deltix.containers.binaryarrayoptimizations;
 ...
 */
public class BinaryArrayOptimizationTotal implements BinaryArrayOptimization {
    ...
    public boolean equals(long[] data1, long[] data2, int count) {
        for (int i = 0; i < count; ++i) if (data1[i] != data2[i]) return false;
        return true;
    }
