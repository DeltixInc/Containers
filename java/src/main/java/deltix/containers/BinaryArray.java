...
import deltix.containers.binaryarrayoptimizations.BinaryArrayOptimizationTotal;
import deltix.containers.generated.*;
import deltix.containers.interfaces.*;
import deltix.containers.binaryarrayoptimizations.*;
import deltix.containers.interfaces.*;
import deltix.containers.generated.*;
...
public class BinaryArray implements BinaryConvertibleReadWrite {
    ...
    @Override
    public void toUUID(deltix.containers.interfaces.UUID buffer) {
        buffer.setMSB(toInt64(0));
        buffer.setLSB(toInt64(8));
    }

    @Override
    public void toUUID(deltix.containers.interfaces.UUID buffer, int offset) {
        buffer.setMSB(toInt64(offset));
        buffer.setLSB(toInt64(offset + 8));
    }

    @Override
    public void toMutableString(deltix.containers.interfaces.MutableString str) {
        toMutableString(str, 0);
    }

    @Override
    public void toMutableString(deltix.containers.interfaces.MutableString str, int offset) {
        str.clear();
    ...
    @Override
    public void toMutableString(deltix.containers.interfaces.MutableString str, int offset, int length) {
        str.clear();
    ...
    @Override
    public deltix.containers.MutableString toMutableString() {
        deltix.containers.MutableString string = new deltix.containers.MutableString();
