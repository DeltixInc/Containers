...
public class MutableString implements deltix.containers.interfaces.MutableString {
    ...
    @Override
    public void copyTo(deltix.containers.interfaces.MutableString str) {
        str.assign(this);
    }
    ...
    @Override
    public void toUUID(deltix.containers.interfaces.UUID uuid) {
        uuid.assign(this);
    }

    @Override
    public void toUUID(deltix.containers.interfaces.UUID uuid, int offset) {
        uuid.assign(this, offset);
    }

    @Override
    public void toUUID(deltix.containers.interfaces.UUID uuid, UUIDParseFormat format) {
        uuid.assign(this, format);
    }

    @Override
    public void toUUID(deltix.containers.interfaces.UUID uuid, int offset, UUIDParseFormat format) {
     ...
     */
    @Override
    public deltix.containers.interfaces.MutableString secureClear() {
     ...
     */
    @Override
    public deltix.containers.interfaces.MutableString assign(boolean item) {
        resetHashCode();
        clear();
        return append(item);
    }
     ...
     */
    @Override
    public deltix.containers.interfaces.MutableString assign(float item) {
        resetHashCode();
        clear();
        return append(item);
    }
