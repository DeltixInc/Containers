...
public class BinaryArrayTests {
    ...
    public void testToHexString() {
        ...
        a.append((byte) 2);
        a.append((byte) 3);
        assertEquals("010203", a.toString(deltix.containers.interfaces.CharEncoding.HEX));
        StringBuilder builder = new StringBuilder();
        a.getChars(deltix.containers.interfaces.CharEncoding.HEX, builder, 0);
        assertEquals("010203", builder.toString());
        for (int i = 0; i < 256; ++i) {
            a.assign((byte) i);
            assertEquals("" + HEX_DIGITS_UPPER[i >>> 4] + HEX_DIGITS_UPPER[i & 0x0F], a.toString(deltix.containers.interfaces.CharEncoding.HEX));
        }
    ...
    public void testToASCIIString() {
        ...
        a.append((byte) 49);
        a.append((byte) 50);
        assertEquals("012", a.toString(deltix.containers.interfaces.CharEncoding.ASCII));
        StringBuilder builder = new StringBuilder();
        a.getChars(deltix.containers.interfaces.CharEncoding.ASCII, builder, 0);
    ...
    public void testUTF8String() {
        ...
        a.append('1');
        a.append('2');
        assertEquals("012", a.toString(deltix.containers.interfaces.CharEncoding.UTF8));
        StringBuilder builder = new StringBuilder();
        a.getChars(deltix.containers.interfaces.CharEncoding.UTF8, builder, 0);
        assertEquals("012", builder.toString());
    }
